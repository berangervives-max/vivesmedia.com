  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-y-0 -ml-0.5 w-1" style={{ left: `${pos}%`, background: '#F4521E' }}>
        <span className="absolute top-1/2 left-1/2 flex h-9 w-9 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full text-white shadow-lg" style={{ background: 'var(--brand-cta)' }}>
