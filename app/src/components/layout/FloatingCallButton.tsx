...
export default function FloatingCallButton() {
  ...
  return (
    <button
      ...
      className={`hidden sm:flex fixed bottom-6 right-6 z-40 items-center gap-2 text-white font-semibold pl-4 pr-5 py-3 rounded-xl transition-all duration-300 hover:scale-105 ${show ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}
      style={{ backgroundColor: 'var(--brand-cta)', boxShadow: '0 10px 34px rgba(244,82,30,0.45)' }}
    >
