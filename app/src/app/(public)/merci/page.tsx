    ...
    <div className="min-h-screen bg-background flex items-center justify-center pt-20 pb-20">
      ...
      <div className="max-w-md w-full mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/" className="flex items-center justify-center gap-2 text-white font-semibold px-6 py-3 rounded-full text-sm btn-orange-glow" style={{ backgroundColor: 'var(--brand-cta)' }}>
            Retour à l'accueil
          </Link>
