...
const PROJECTS: ProjectCard[] = [
  ...
  { num: '02', name: 'Yannis Amielh', type: 'Portfolio · Mannequin Éditorial', year: '2026', href: '/realisations/yannis-amielh', img: '/images/realisations/yannis-site-desktop.jpg', tags: ['Portfolio', 'Direction Artistique', '3D'] },
  { num: '03', name: 'Vives Reports', type: 'Site Éditorial · Guide Touristique Rome', year: '2022', href: '/realisations/vives-reports', img: '/images/realisations/vivesreports-desktop.png', tags: ['Éditorial', 'SEO', 'React'] },
  ...
  { num: '05', name: 'Ecoserre', type: 'Site Vitrine · Habitat Durable', year: '2024', href: '/realisations/ecoserre', img: '/images/realisations/ecoserre-desktop.png', tags: ['Site Vitrine', 'Green', 'SEO'] },
