...
const PROJECTS = [
  ...
  { num: '02', name: 'Vives Reports', type: 'Site Éditorial · Guide Touristique Rome', year: '2022', href: '/realisations/vives-reports', img: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/render/image/public/base44-prod/public/69399ee5f49ad57466b051e2/000074367_tourgarbatella-aubinvives_pmvillareal-27.png?width=800&quality=75&format=webp', tags: ['Éditorial', 'SEO', 'React'] },
  { num: '03', name: 'Paul & Louis Sport', type: 'Site Vitrine · Club Padel', year: '2024', href: '/realisations/paul-et-louis-sport', img: 'https://media.base44.com/images/public/69f3530cd3a27defe3c78f69/44abc6e41_p1049264-high-o0dyng.png', tags: ['Site Vitrine', 'Sport', 'Design'] },
  { num: '04', name: 'Ecoserre', type: 'Site Vitrine · Habitat Durable', year: '2024', href: '/realisations/ecoserre', img: 'https://design-digest-adapt.lovable.app/assets/hero-greenhouse-D5yU2Vvh.jpg', tags: ['Site Vitrine', 'Green', 'SEO'] },
  { num: '05', name: 'Wood Design', type: 'Site Catalogue · Artisan Bois', year: '2024', href: '/realisations/wood-design', img: 'https://images.unsplash.com/photo-1504148455328-c376907d081c?w=800&q=80', tags: ['Catalogue', 'Artisan', 'Design'] },
]
